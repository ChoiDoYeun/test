...
#    qr_thread = threading.Thread(target=process_qr_code_input, args=(warehouse,))
    qr_thread = threading.Thread(target=process_qr_code, args=(warehouse,input))
    qr_thread.start()
...
#        qr_thread.join()  # 스레드가 종료될 때까지 기다립니다.
        qr_thread = threading.Thread(target=process_qr_code, args=(warehouse,normal))
...
#    qr_thread = threading.Thread(target=process_qr_code_output, args=(warehouse,))
    qr_thread = threading.Thread(target=process_qr_code, args=(warehouse,output))
#    qr_thread.start()
